...
module.exports = {
    mode: 'development',
    entry: ['./local/templates/dw/src/js/index.js','./local/templates/dw/src/css/style.scss'],
    output: {
        filename: 'bundle.js',
        path: path.resolve(__dirname, 'local/templates/dw/dist/'),
        publicPath: '/local/templates/dw/dist/'
    },
    devServer: {
        hot: true,
        static: {
